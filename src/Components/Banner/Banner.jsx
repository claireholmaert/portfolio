    ...
    return (
        ...
        <div className="banner" id='skills'>
            <div className="banner_content">
                <img src="/images/html-5.svg" alt="logo html"/>
                ...
                <img src="/images/symfony.svg" alt="logo symfony"/>
                <img src="/images/mysql.svg" alt="logo mysql"/>
                <img src="/images/docker-icon.svg" alt="logo docker"/>
            </div>
            <div className="banner_content">
                <img src="/images/html-5.svg" alt="logo html"/>
                <img src="/images/css-3.svg" alt="logo css"/>
